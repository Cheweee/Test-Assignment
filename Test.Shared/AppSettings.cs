...
namespace Test.Shared
{
    public static class AppSettings
    {
        ...
        public static string MSSqlServerConnectionString => $"data source={DatabaseHost};initial catalog={DatabaseName};user id={DatabaseUserName};password={DatabasePassword};";
